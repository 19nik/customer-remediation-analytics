...
6. Machine learning prediction using Logistic Regression
...
- Some impacted customers did not raise complaints

Business Impact
Helps remediation teams:
- Identify impacted customers quickly
